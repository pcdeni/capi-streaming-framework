...
public class Trainer {
	...
	public static Network Train(double[][] inputData) throws IOException {
		...
		CustomLogger.Log("get deltas \t" + deltaCalcTime/1000000000 + "seconds\r\n");
		CustomLogger.Log("apply deltas \t" + deltaApplTime/1000000000 + "seconds\r\n");
		CustomLogger.Log("validate \t" + validationTime/1000000000 + "seconds\r\n");
		CustomLogger.Log("stopped after " + iterations + " iterations, with errors(t,v,b): " + trainError + ", " + validationError + ", " + bestValidationError + "\n\r");
		return model;
